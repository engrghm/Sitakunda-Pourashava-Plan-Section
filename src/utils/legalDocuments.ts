...
export const DEFAULT_LEGAL_DOCUMENTS: LegalDocumentItem[] = [
  {
    ...
    year: '১৯৯৬',
    description: 'বিধি ১-৩০, নকশা প্রণয়নকারীর যোগ্যতা ও উন্মুক্ত স্থান (সেটব্যাক) সংক্রান্ত বিধানাবলী।',
    fileUrl: '',
    fileName: '',
  ...
  },
  {
    ...
    category: 'অগ্নি নিরাপত্তা ও নির্বাপণ',
    year: '২০০৩',
    description: 'ভবনে পর্যাপ্ত অগ্নিনির্বাপক ব্যবস্থা, জরুরি বহির্গমন সিঁড়ি ও জীবন-সম্পদ নিরাপত্তা বিধান।',
    fileUrl: '',
    fileName: '',
