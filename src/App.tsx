      ...
      <Header
        ...
        onOpenCitizenServiceInfo={(service) => {
          if (service === 'holding') {
            ...
            alert('সীতাকুণ্ড পৌরসভা নাগরিক সনদ ও প্রত্যয়নপত্র সেবা:\n\nনাগরিকত্ব সনদ, চারিত্রিক সনদ, ওয়ারিশান সনদপত্র এবং পারিবারিক সনদের জন্য সংশ্লিষ্ট ওয়ার্ড কাউন্সিলর কার্যালয়ের সুপারিশসহ পৌর প্রশাসনিক শাখায় আবেদন করতে পারবেন।');
          }
        }}
      />
